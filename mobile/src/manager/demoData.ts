...
export const expenseCategoryLabels: Record<Expense['category'], { en: string }> = {
  fuel: { en: 'Fuel' },
  food: { en: 'Food' },
  repairs: { en: 'Repairs (misc)' },
  utilities: { en: 'Utilities' },
  salary: { en: 'Staff salary' },
  raw_material: { en: 'Raw material' },
  vehicle_maintenance: { en: 'Vehicle maintenance' },
  plant_maintenance: { en: 'Plant maintenance' },
  marketing: { en: 'Marketing' },
  rent: { en: 'Rent' },
  insurance: { en: 'Insurance' },
  refreshments: { en: 'Refreshments' },
  other: { en: 'Owner withdrawal (personal)' },
};
